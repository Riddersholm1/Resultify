...
public readonly struct Result<TValue> : IEquatable<Result<TValue>>
{
    ...
    /// <remarks>
    /// When <typeparamref name="TValue"/> is <see cref="Error"/>, or a type an <see cref="Error"/>
    /// is assignable to (e.g. <see cref="object"/>), the <see cref="Error"/> conversion is chosen and
    /// the result is a failure. Use <see cref="Success(TValue)"/> to wrap such a value as a success.
    /// </remarks>
    /// </summary>
